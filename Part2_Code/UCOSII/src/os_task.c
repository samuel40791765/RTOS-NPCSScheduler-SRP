...
INT8U  OSTaskCreate (void (*task)(void *p_arg), void *p_arg, OS_STK *ptos, INT8U prio, INT32U id ,INT32U arrivaltime, INT32U ctime, INT32U ptime)
{
    OS_STK    *psp;
    INT8U      err;
    ...
    if (OSTCBPrioTbl[prio] == (OS_TCB *)0) { /* Make sure task doesn't already exist at this priority  */
        ...
        if(prio != OS_TASK_IDLE_PRIO){
            ...
            OSTCBPrioTbl[prio]->TASK_SHOULD_START_TIME = arrivaltime;
            OSTCBPrioTbl[prio]->ARRIVAL_TIME = arrivaltime;
            OSTCBPrioTbl[prio]->compute = ctime; 
            OSTCBPrioTbl[prio]->period = ptime; 
            OSTCBPrioTbl[prio]->DEADLINE = arrivaltime + ptime;
            OSTCBPrioTbl[prio]->ORIGINAL_DEADLINE = OSTCBPrioTbl[prio]->DEADLINE;
        }  
